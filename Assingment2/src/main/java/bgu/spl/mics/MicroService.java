...
public abstract class MicroService implements Runnable {
    ...
    private final MessageBusImpl message_bus;
    private final HashMap<Class<? extends Message>, Callback> callback_map;
    ...
    public MicroService(String name) {
        ...
        this.message_bus = MessageBusImpl.getInstance();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        message_bus.subscribeEvent(type, this);
        callback_map.put(type, callback);
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        message_bus.subscribeBroadcast(type, this);
        callback_map.put(type, callback);
    }
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        return message_bus.sendEvent(e);
    }
    ...
    public final void run() {
        ...
        while(!terminated){
            try {
                Message message = message_bus.awaitMessage(this);
                if(message != null) {
                    callback_map.get(message.getClass()).call(message);
                }
